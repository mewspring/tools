...
func main() {
	...
	pkgPath, err := goutil.RelImpPath(g.pkg.dir)
	if err != nil {
		log.Fatalf("unable to locate relative package import path for %q; %+v", g.pkg.dir, err)
	}
	g.Printf("// Code generated by \"string2enum %s\"; DO NOT EDIT.\n", strings.Join(os.Args[1:], " "))
	g.Printf("\n")
